...
public class LoginCommand implements Command {
    ...
    @Override
    public CommandResult execute(HttpServletRequest servletRequest) throws  by.niitzi.bushylo.v3.exception.ServiceException, javax.xml.rpc.ServiceException {
        String userName = servletRequest.getParameter("username");
        String password = servletRequest.getParameter("password");

        Optional<Client> client = clientService.findClient(userName);
